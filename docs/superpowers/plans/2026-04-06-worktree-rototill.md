...
**Goal:** Make superfastpowers defer to native harness worktree systems when available, fall back to manual git worktrees when not, and fix three known finishing bugs.
...
**Spec:** `docs/superfastpowers/specs/2026-04-06-worktree-rototill-design.md`
...
**If worktree path is under `.worktrees/` or `~/.config/superfastpowers/worktrees/`:** Superfastpowers created this worktree — we own cleanup.
...
- **Fix:** Only clean up worktrees under `.worktrees/` or `~/.config/superfastpowers/worktrees/`
