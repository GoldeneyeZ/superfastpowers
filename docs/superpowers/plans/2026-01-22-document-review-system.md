...
> **For agentic workers:** REQUIRED: Use superfastpowers:subagent-driven-development (if subagents available) or superfastpowers:executing-plans to implement this plan.
...
**Spec:** docs/superfastpowers/specs/2026-01-22-document-review-system-design.md
...
```markdown
> **For agentic workers:** REQUIRED: Use superfastpowers:subagent-driven-development (if subagents available) or superfastpowers:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
