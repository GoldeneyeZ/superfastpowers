...
## Is this a Superfastpowers issue or a platform issue?
<!-- Superfastpowers is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Superfastpowers installed.

     If the problem persists without Superfastpowers, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Superfastpowers installed
