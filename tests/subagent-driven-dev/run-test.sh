...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/superfastpowers
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/superfastpowers-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using superfastpowers:subagent-driven-development. The plan is at: $PLAN_PATH"
