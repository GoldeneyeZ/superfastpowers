...
Execute this plan using the `superfastpowers:subagent-driven-development` skill.
...
**Do:**
- Initialize `go.mod` with module name `github.com/superfastpowers-test/fractals`
